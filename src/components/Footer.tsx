        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/perfume-guide" className="text-xs hover:text-pink-400 transition-colors font-semibold text-pink-300">香水おすすめランキング</Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/diet-beauty-guide" className="text-xs hover:text-pink-400 transition-colors font-semibold text-green-300">美容ダイエットガイド</Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/eye-makeup-guide" className="text-xs hover:text-pink-400 transition-colors font-semibold text-rose-300">アイメイクガイド</Link>
              </li>
              <li>
