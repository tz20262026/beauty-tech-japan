    ...
    <header className="bg-gray-950 text-white sticky top-0 z-10 border-b border-gray-800">
      <div className="max-w-5xl mx-auto px-4 h-14 flex items-center justify-between gap-2">
        <Link href="/" className="flex items-center gap-1.5 group shrink-0">
          ...
          <span className="text-base sm:text-lg font-bold tracking-tight whitespace-nowrap group-hover:text-pink-400 transition-colors">
            Tech Japan
          </span>
        </Link>
        <nav className="flex items-center gap-2 sm:gap-3 text-sm text-gray-300">
          <Link href="/skin-type-diagnosis" className="flex items-center gap-1 min-h-[44px] px-2.5 py-1 rounded-full bg-pink-500 text-white font-bold text-[11px] sm:text-xs whitespace-nowrap shrink-0 hover:bg-pink-400 transition-colors">
            🧴 肌タイプ診断
          </Link>
