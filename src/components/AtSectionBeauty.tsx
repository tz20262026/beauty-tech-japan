...
const items: AtItem[] = [
  {
    // 成果報酬 13,186円（2026-07-22追加）
    rk: "0100q6ca00ovmt",
    badge: "✨ 話題の美容ケアセット",
    badgeColor: "#ec4899",
    title: "RadiantGrace 特別セット",
    tagline: "自宅で続けられる美容ケアの特別セット",
    desc: "クリニック通いの前に、まずは自宅ケアで様子を見たい人向けの特別セット。定期的な通院が難しい人でも、続けやすい形で取り入れられます。",
    cta: "セット内容を見る →",
    color: "#ec4899",
  },
  {
    // 成果報酬 12,000円（2026-07-22追加）
    rk: "0100pq8000ovmt",
    badge: "💉 プチ美容医療の相談窓口",
    badgeColor: "#8b5cf6",
    title: "渋谷美容外科クリニック",
    tagline: "無料カウンセリング｜来院で成立",
    desc: "「気になるけど、いきなり施術は不安」という人向けに、まずは無料カウンセリングで相談できるクリニック。話を聞いてから決められるので、一歩目のハードルが低いのが特徴です。",
    cta: "無料カウンセリングを見る →",
    color: "#8b5cf6",
  },
  {
  ...
  {
    // 成果報酬 7,325円（2026-08-06追加）
    rk: "0100q22m00ovmt",
    badge: "✨ 話題のレチノール美容液",
    badgeColor: "#ec4899",
    title: "レチベイビー",
    tagline: "初めてのレチノールケアに向けた美容液",
    desc: "レチノールは刺激が気になって手を出せていなかった人向けに設計された美容液。新規購入限定のキャンペーンから始められます。",
    cta: "商品を見る →",
    color: "#ec4899",
  },
  {
    // 成果報酬 5,000円（2026-08-06追加）
    rk: "0100kzaf00ovmt",
    badge: "👙 補整下着で体型ケア",
    badgeColor: "#a855f7",
    title: "マルコ（MARUKO）の補整下着",
    tagline: "63万人が体験した無料試着カウンセリング",
    desc: "自宅ケアだけでは変えにくい体のラインを、補整下着とプロのフィッティングで整えるアプローチ。まずは無料の試着体験から確認できます。",
    cta: "無料試着体験を見る →",
    color: "#a855f7",
  },
  {
    // 成果報酬 3,750円（2026-08-06追加）
    rk: "0100m7o300ovmt",
    badge: "🌿 デリケートゾーンのケア",
    badgeColor: "#14b8a6",
    title: "イビサセラムpro",
    tagline: "デリケートゾーン用の美容液",
    desc: "顔や髪だけでなく、見落とされがちなデリケートゾーンのくすみ・においケアに向けた美容液。ドラッグストアでは見つけにくいアイテムです。",
    cta: "商品を見る →",
    color: "#14b8a6",
  },
];
