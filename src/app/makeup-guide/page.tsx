...
export const metadata: Metadata = {
  ...
  title: "メイクアップ初心者完全ガイド2026年版【ベース・アイ・リップの順番】",
  description:
  ...
  return (
    <main className="bg-gray-950 min-h-screen text-gray-100">
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        <Breadcrumb variant="dark" items={[{ name: "ホーム", href: "/" }, { name: "メイクアップ初心者ガイド" }]} />
              ...
              <div key={s.n} className="bg-gray-900 border border-gray-700 rounded-xl p-4">
                <div className="flex gap-4 items-start">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-gray-300 text-xs leading-relaxed mb-1">{s.how}</p>
