...
export const metadata: Metadata = {
  ...
  title: "ヘアケア完全ガイド2026年版【髪質改善・おすすめシャンプー10選】",
  description:
            ...
            {HAIR_TYPES.map((h, i) => (
              <div key={i} className="bg-gray-900 border border-gray-700 rounded-xl p-4">
                ...
                <div className="mb-2">
                  ...
                  <ul className="space-y-0.5">
                    {h.issues.map((issue, j) => (
                      <li key={j} className="text-gray-300 text-xs">・{issue}</li>
                    ))}
                  </ul>
                </div>
                <div className="mb-2">
                  ...
                  <ul className="space-y-0.5">
                    {h.recommendations.map((r, j) => (
                      <li key={j} className="text-gray-300 text-xs">・{r}</li>
                    ))}
                  </ul>
                </div>
                <div className="bg-orange-500/10 border border-orange-500/20 rounded px-2 py-1.5">
                  ...
                  <span className="text-gray-300 text-xs">{h.avoid}</span>
                </div>
              </div>
            ))}
          </div>
