  ...
  return (
    <main className="bg-gray-950 min-h-screen text-gray-100">
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
              ...
              <div key={trend.color} className="bg-gray-900 border border-gray-700 rounded-xl p-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs">
                  <div className="bg-gray-800 rounded px-3 py-2">
                    <p className="text-gray-300 font-bold mb-1">✨ 効果</p>
                    <p className="text-gray-300 leading-relaxed">{trend.effect}</p>
                  </div>
                  <div className="bg-gray-800 rounded px-3 py-2">
                    <p className="text-gray-300 font-bold mb-1">🌸 おすすめ肌色</p>
          ...
          <div className="space-y-5">
            {EYELID_TYPES.map((eyelid) => (
              ...
              >
                ...
                <p className="text-gray-300 text-xs mb-3 leading-relaxed">{eyelid.point}</p>
        ...
        <ArticleAffiliateCard tags={[]} articleId="eyeshadow-guide" />
            ...
            {APPLY_STEPS.map((s) => (
              <div key={s.step} className="flex gap-4 bg-gray-900 border border-gray-700 rounded-xl p-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-gray-300 text-xs leading-relaxed">{s.tip}</p>
                </div>
              </div>
            ))}
          </div>
              ...
              <tbody>
                {[
                  ...
                  <tr key={row.brush} className={i % 2 === 0 ? "bg-gray-900" : "bg-gray-950"}>
                    ...
                    <td className="px-4 py-3 text-gray-300">{row.tip}</td>
                  </tr>
                ))}
              </tbody>
            </table>
