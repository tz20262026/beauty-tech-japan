...
export const metadata: Metadata = {
  ...
  title: "アイメイクの正しいやり方2026年版【初心者向け完全ガイド】",
  description:
  ...
  return (
    <main className="bg-gray-950 min-h-screen text-gray-100">
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        <Breadcrumb variant="dark" items={[{ name: "ホーム", href: "/" }, { name: "アイメイクガイド" }]} />
              ...
              <div key={step.step} className="bg-gray-900 border border-gray-700 rounded-xl p-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 mb-3 text-xs">
                  <div className="bg-gray-800 rounded px-2.5 py-1.5">
                    <span className="text-gray-300">🖌️ 道具：</span>
                    <span className="text-gray-200">{step.tool}</span>
                  </div>
                  <div className="bg-gray-800 rounded px-2.5 py-1.5">
                    <span className="text-gray-300">✅ ポイント：</span>
                    <span className="text-gray-200">{step.key}</span>
                  </div>
                </div>
                <p className="text-gray-300 text-xs leading-relaxed">{step.tip}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <ArticleAffiliateCard tags={[]} articleId="eye-makeup-guide" />
