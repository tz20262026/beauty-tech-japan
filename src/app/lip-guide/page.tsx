...
export const metadata: Metadata = {
  ...
  title: "リップメイク・リップケア完全ガイド2026年版【塗り方・乾燥対策】",
  description:
  ...
  return (
    <main className="bg-gray-950 min-h-screen text-gray-100">
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        <Breadcrumb variant="dark" items={[{ name: "ホーム", href: "/" }, { name: "リップメイク・ケアガイド" }]} />
            ...
            {LIP_TYPES.map((lip, i) => (
              <div key={i} className="bg-gray-900 border border-gray-700 rounded-xl p-5">
                ...
                <div className="bg-gray-800 rounded px-2.5 py-1.5 text-xs mb-3">
                  <span className="text-gray-300">✨ 仕上がり：</span>
                  <span className="text-gray-200">{lip.finish}</span>
                </div>
                <p className="text-gray-300 text-xs leading-relaxed">{lip.best}</p>
              </div>
            ))}
          </div>
        </section>
